...
public class ModItems {
    ...
    public static final Item tracker_compass = new ItemTrackerCompass().setMaxStackSize(1)
        .setUnlocalizedName("tracker_compass")
        .setCreativeTab(CreativeTabs.tabMisc)
        .setTextureName(RefStrings.MODID + ":tracker_compass");
